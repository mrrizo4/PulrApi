...
namespace Core.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20231030090945_SpotsProfileMentions")]
    partial class SpotsProfileMentions
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Domain.Entities.Post", b =>
                {
                    ...
                    b.Property<DateTime>("SpotExpiresIn")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Core.Domain.Entities.Spot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Core.Domain.Entities.SpotHashTag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("SpotHashTags");
                });

            modelBuilder.Entity("Core.Domain.Entities.SpotProductTag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("SpotProductTags");
                });

            modelBuilder.Entity("Core.Domain.Entities.SpotProfileMention", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Core.Domain.Entities.Product", b =>
                {
                    ...
                    b.HasOne("Core.Domain.Entities.ProductCategory", "ProductCategory")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Core.Domain.Entities.Profile", b =>
                {
                    ...
                    b.HasOne("Core.Domain.Entities.Spot", null)
                        .WithMany("LikedBy")
            ...
            modelBuilder.Entity("Core.Domain.Entities.SpotHashTag", b =>
                {
                    ...
                    b.HasOne("Core.Domain.Entities.Spot", "Spot")
                        .WithMany("SpotHashTags")
                        .HasForeignKey("SpotId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Core.Domain.Entities.Spot", b =>
                {
                    ...
                    b.Navigation("SpotProfileMentions");
                });
