...
public class UpdateUserFinanceCommandValidator : AbstractValidator<UpdateStripeIndividualCommand>
{
    private readonly IApplicationDbContext _dbContext;
    private readonly ICurrentUserService _currentUserService;

    public UpdateUserFinanceCommandValidator(IApplicationDbContext dbContext, ICurrentUserService currentUserService)
    {
